...
use App\Http\Controllers\QueueAnalyzeTaskController;
use App\Http\Controllers\QueueGlobalAgentChatController;
...
Route::post('/tasks/{task}/analyze/queue', QueueAnalyzeTaskController::class);
...
Route::post('/agent/chat/queue', QueueGlobalAgentChatController::class);
